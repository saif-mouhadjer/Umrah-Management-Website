                ...
                <div class="w-full lg:w-6/12 px-4">
                    <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300">
                        ...
                        <form method="POST" action="" class="flex-auto p-5  ">
                            <h4 class="text-2xl font-semibold text-center">تسجيل الدخول</h4>
                            <div class="relative w-full mb-3 mt-8">
                                <label class="block uppercase text-gray-700 text-base font-bold mb-2" for="full-name">رقم بطاقة جواز السفر</label>
                                <input name="num_pas_p" type="text" class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-base shadow focus:outline-none focus:ring w-full" style="transition: all 0.15s ease 0s;" />
                            </div>
                            ...
                            <div class="text-center mt-6">
                                <button name="login" class="bg-green-800 text-white active:bg-green-500 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1" type="submit" style="transition: all 0.15s ease 0s;">تسجيل</button>
                            </div>
                        </form>
                    </div>
                </div>
